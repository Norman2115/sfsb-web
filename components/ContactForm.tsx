        ...
        <div className="flex flex-col md:flex-row justify-between mb-8 space-y-8 md:space-y-0">
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-gray-900">
              Please see our list of distributors to find the nearest one to
              you.
            </p>
          </div>
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-gray-900">
              To create a ticket, please use the submission form.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
            <div className="md:w-1/3">
              ...
              <div className="text-center md:text-left mt-4">
                ...
                <p className="text-gray-900">+6 (0) 970 44 99 11</p>
              </div>
              <div className="text-center md:text-left mt-4">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-900 mb-4">
                For sales inquiries and product information, please complete the
                below form and an Summit Sales Representative will get back
                to you. By submitting this form you acknowledge that you have
                read, understood and agree to our{" "}
              ...
              <form className="space-y-4">
                <div className="flex flex-col md:flex-row md:space-x-4">
                  <div className="w-full md:w-1/2">
                    ...
                    <input
                      type="text"
                      className="mt-1 block w-full border-gray-500 rounded-md py-2 px-4 h-10 focus:border-blue-500 focus:ring-blue-200"
                      required
                    />
                  </div>
                  <div className="w-full md:w-1/2">
                ...
                <div>
                  ...
                  <textarea
                    className="mt-1 block w-full border-gray-500 rounded-md py-2 px-4 focus:border-blue-500 focus:ring-blue-200"
                    rows={4}
                    required
                  ></textarea>
                </div>
                <div className="flex items-center">
                  ...
                  <label className="ml-2 block text-gray-900">
                    Sign up for emails to hear the latest from Summit Features.
                  </label>
                </div>
                <div>
                  <button
